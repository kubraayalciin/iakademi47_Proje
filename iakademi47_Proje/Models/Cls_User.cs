...
namespace iakademi47_Proje.Models
{
	public class Cls_User
	{
        ...
        {
            //static olduğu için usingi burda
        ...
        public static bool SendSms( string OrderGroupGUID)
        {
            ...
            try
            {
                using (iakademi47Context context = new iakademi47Context()) 
                {
                    ...
                    ss += "<msgheader>BAŞLIK BURDA</msgheader>";
                    ss += "</header>";
                    ss += "<body>";
                    ...
                    string icerik = "Sayın"+ user.NameSurname+ ","+ DateTime.Now+ " tarihinde"+ OrderGroupGUID + " numaralı siparişiniz alınmıştır.";
                    ...
                    {
                           //sms gitmediyse, Orders tablosunda sms kolununda false bas
        ...
        public static string XmlPost(string url, string ss)
        {
            try
            {
                ...
                HttpWebRequest request = WebRequest.Create(url) as HttpWebRequest;// casting yani tip dönüştürme

                //• Casting = tip dönüştürme
                //• ConvertToHttpWebRequest(WebRequest.Create(url)) böyle bir hazır convert yok
        ...
        public static void SendEmail(string OrderGroupGUID)
        {
            using (iakademi47Context context = new iakademi47Context())
            {
                ...
                //application server - visualstudio kodları
                //database server - sql dataları
                //Mail server  - mailin ipsi ve portu login şifre tutulan yerdir.
